...
st.subheader("チェック結果")
message = '6点以上の場合にはうつ病の傾向が疑われます。チェックシートの結果のみで正確な診断をすることはできません。結果の如何にかかわらず不安がある場合には、カウンセラーもしくは専門の医師に相談してください。'
...
st.write('')
st.write('#### ※QIDS-Jの使い方')
st.write('#### 厚生労働省ホームページ「QIDS-J解説」を参考にチェックシートを作成しております。')
